    ...
    <table className='crypto-table'>
        ...
        <tbody className='table-body'>
            <tr className='table-row' style={{backgroundColor: isDarkMode ? '#2e3241' : '#f8f9fa'}}>
                ...
                <td className='table-data color-green'>0.43%</td>
                <td className='table-data color-green'>&#9650; &#8377;18,418</td>
            </tr>
            <tr className='table-row' style={{backgroundColor: isDarkMode ? '#2e3241' : '#f8f9fa'}}>
                ...
                <td className='table-data color-red'>-0.04%</td>
                <td className='table-data color-red'>&#9660; &#8377;1,685</td>
            </tr>
            <tr className='table-row' style={{backgroundColor: isDarkMode ? '#2e3241' : '#f8f9fa'}}>
                ...
                <td className='table-data color-red'>-1.81%</td>
                <td className='table-data color-red'>&#9660; &#8377;77,518</td>
            </tr>
            <tr className='table-row' 
            style={{backgroundColor: isDarkMode ? '#2e3241' : '#f8f9fa'}}>
                ...
                <td className='table-data color-red'>-0.12%</td>
                <td className='table-data color-red'>&#9660; &#8377;5,049</td>
            </tr>
            <tr className='table-row' style={{backgroundColor: isDarkMode ? '#2e3241' : '#f8f9fa'}}>
                ...
                <td className='table-data color-green'>0.87%</td>
                <td className='table-data color-green'>&#9650; &#8377;37,418</td>
            </tr>
            <tr className='table-row'style={{backgroundColor: isDarkMode ? '#2e3241' : '#f8f9fa'}}>
                ...
                <td className='table-data color-green'>0.66%</td>
                <td className='table-data color-green'>&#9650; &#8377;28,418</td>
            </tr>
        </tbody>
    </table>
  );
